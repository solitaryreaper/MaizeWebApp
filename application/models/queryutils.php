...
class Queryutils extends CI_Model {
    ...
    private function get_query_display_columns($query, $field_prefix, $field_suffix, $excluded_columns)
    {
    ...
    private function get_phenotype_query_select_clause($phenotype_metadata_query, $phenotype_measurement_query, $form_vars)
    {
    	...
    	if(!$this->is_aggregate_function_report($form_vars)) {
    		...
    		$phenotype_metadata_select_string = 
    			$this->get_query_display_columns($phenotype_metadata_query, 'phenotypes_metadata.', '', $excluded_columns);
    		$phenotype_measurement_select_string = 
    			$this->get_query_display_columns($phenotype_measurement_query, 'phenotypes_measurements.', '', $excluded_columns);
    		...
    		$phenotype_metadata_select_string = 
    			$this->get_query_display_columns($phenotype_metadata_query, 'phenotypes_metadata.', '', $excluded_columns);
    		$phenotype_measurement_select_string = 
    			$this->get_query_display_columns($phenotype_measurement_query, $aggregate_function . '(phenotypes_measurements.', ')', $excluded_columns);
